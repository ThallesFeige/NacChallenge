      ...
      <Stack.Screen
        ...
        {(props) => (
          <View
            ...
            <Text
              style={{ color: '#3268a8', fontSize: 25, fontWeight: 'bold' }}>
              Configurações
            </Text>
            <TouchableOpacity
              onPress={() => navigation.navigate('sobre')}
              style={{ marginTop: 20 }}>
              <Text style={{ fontSize: 23, color: '#3268a8', marginTop: 50 }}>
                Sobre Dorgan
              </Text>
            </TouchableOpacity>
            <Text style={{ fontSize: 23, color: '#3268a8', marginTop: 50 }}>
            ...
            <Text style={{ fontSize: 20, color: '#3268a8', marginTop: 20 }}>
              Email: Dorgan@gmail.com
            </Text>
            <Text style={{ fontSize: 20, color: '#3268a8', marginTop: 20 }}>
              Telefone: 11 5577-8888
            </Text>
          </View>
        )}
      </Stack.Screen>
...
function PrincipalStack() {
  return (
    <Stack.Navigator>
      ...
      <Stack.Screen name="config" options={{ title: 'Tela de configuração' }}>
        {(props) => <ConfigScreen />}
      </Stack.Screen>

      <Stack.Screen name="Depoi" options={{ title: 'Depoimentos' }}>
        {(props) => <DepoimentosScreen />}
      </Stack.Screen>

      <Stack.Screen name="JunteSe" options={{ title: 'Junte-se a causa' }}>
        {(props) => <JunteSeScreen />}
      </Stack.Screen>

      <Stack.Screen name="Duvidas" options={{ title: 'Chat Duvidas' }}>
        {(props) => <DuvidasScreen />}
      </Stack.Screen>
    </Stack.Navigator>
  );
